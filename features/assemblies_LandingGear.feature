Feature: To verify adding new Assemblies Landing Gear with all details
  ...
  Scenario: Verify able to add new Assemblies
    ...
    And user fill-in "Assemblies_LandingGear" information from datasheet
  ...
  Scenario: Verify able to edit existing Assemblies
    When user selects newly added "444000888" aircraft
  ...
  Scenario: Verify able delete newly added Assemblies
    ...
    Then Verify that aircraft "444000888" is deleted