Feature: To verify Regression scenarios to test Application flow
  ...
  Scenario: Verify able to add new Aircraft
    ...
    Then verify that newly added record is displayed under section "Recent Aircraft"
  ...
  Scenario: Verify able to add new Engine-1 Assembly
    ...
    Then verify that newly added record is displayed under section "Recent Assemblies"
  ...
  Scenario: Verify able to add new Operator
    ...
    Then verify that newly added record is displayed under section "Recent Operators"
  ...
  Scenario: Verify able to add new Lease for Aircraft
    ...
    Then verify that newly added record is displayed under section "Recent Leases"
      | Lease Name   |
      | Orange Lease |
    And user navigates to "Aircraft" tab
  ...
  Scenario: Verify able to add new Ratio table
    ...
    And user clicks on "Save" button
    When user navigates to "Interpolation Table" tab
    Then verify that newly added record is displayed under section "Recent Interpolation Table"
  ...
  Scenario: Verify able to add new Return Conditions
    ...
    Then verify that newly added record is displayed under section "Recent Aircraft Condition Terms"
  ...
  Scenario: Verify able to update lease with Ratio Table and Return Conditions
    ...
    And user clicks on "Save" button
    Then verify that "Ratio table & Return Condition" are added to lease
      | Ratio Table - Engines | Return Condition |
      | ratio_table_300       | Orange Return    |
  ...
  Scenario: Verify able to add new Maintenance Program
    ...
    Then verify that newly added record is displayed under section "Recent Maintenance Program"
