Feature: To verify Regression scenarios to test Workflow - 1
  ...
  Scenario: Verify able to add new Aircraft
    ...
    Then verify that newly added record is displayed in the page
      ...
      | O8429 (A340)   | O8429 | A340          | Available |
  ...
  Scenario: Verify able to add new Operator
    ...
    Then verify that newly added record is displayed in the page
      | Operator Name | Revenue ($M)  | Total Number Of Aircraft |
      | Orange_1Air     | $4,230,000.00 | 12                       |
  ...
  Scenario: Verify able to add new Lease for Aircraft
    ...
    Then verify that Aircraft status is changed to assigned
      | Aircraft Name | MSN  | Aircraft Type | Status   |
      | O8429 (A340)   | O8429 | A340          | Assigned |
...
#      | ratio_table_300          |
    ...
    Then verify that newly added record is displayed under section "Interpolation Adjustments"
      | Interpolation Adjustment Name | Derate Percentage | FH To FC Ratio | Adjustment Factor (Unused) |
      | Adjust_200                    | 5                 | 10.00          | 30.0000                    |

  @testcase
  Scenario: Verify able to add new Return Conditions
    When user navigates to "Return Conditions" tab
    And user clicks on "New" button
    And user fill-in "Return_Conditions" information from regression
    And user clicks on "Save" button
    And user navigates to "Return Conditions" tab
    Then verify that newly added record is displayed in the page
  ...
  Scenario: Verify able to add new Maintenance Program Event
    ...
    Then verify that newly added record is displayed under section "Maintenance Program Event"
      | Event Type | Assembly | Other Details  | Interval 1 ( Cycles ) | Interval 1 ( Hours ) | Interval 1 ( Months ) |
      | Heavy      | Engine   | Engine Service | 120.00                | 800.00               | 3.00                  |

  @testcase
  Scenario: Verify able to add new Monthly Utilization for Aircraft
    When user navigates to "Aircraft" tab
    And user selects newly added "O8429 (A340)" aircraft
...
#    And user clicks on "Show 3 more »" link
    Then verify that Assembly Utilizations are auto created
      | Report Item Type          | Running Hours During Month | Cycles During Month | TSN At Month End | CSN At Month End |
      | Engine 1                  | 300.00                     | 50                  | 5,300.00         | 3,050            |
      | Engine 2                  | 300.00                     | 50                  | 5,100.00         | 3,250            |
      | APU                       | 300.00                     | 50                  | 5,300.00         | 3,050            |
      | Landing Gear - Left Main  | 300.00                     | 50                  | 2,500.00         | 1,650            |
      | Landing Gear - Right Main | 300.00                     | 50                  | 5,300.00         | 2,550            |
      | Landing Gear - Nose       | 300.00                     | 50                  | 5,300.00         | 2,550            |
      | Landing Gear - Left Wing  | 300.00                     | 50                  | 5,300.00         | 2,550            |
      | Landing Gear - Right Wing | 300.00                     | 50                  | 5,300.00         | 2,550            |
    ...
    Then verify that following values are populated in "Base Maintenance Reserve Rates" section
      ...
      | $3,000.00         | $3,000.00         | $100.00      | $5,000.00      |                                       |                                       |                  | 200.00%                   | 100.00%                       | 1.0000                | 1.0000                    |
...
#      | $900,000.00                    | $900,000.00         |
  ...
  Scenario: Verify that on updating FH & FC in Assembly Utilization updates Assembly Utilization and MR
    ...
    And user fill-in aircraft "FH & FC" section
      ...
      | 200                        | 25                  |
    And user clicks on "Save" button
    Then verify that following values are populated in "Assembly Utilization Detail" header section
      | Running Hours During Month | Cycles During Month |
      | 200.00                     | 25                  |
...
#      | $600,000.00                    | $600,000.00         |
    ...
    Then verify that Assembly Utilizations are auto created
      | Report Item Type | Running Hours During Month | Cycles During Month | TSN At Month End | CSN At Month End |
      | Engine 1         | 200.00                     | 25                  | 5,200.00         | 3,025            |
...
#    And user clicks on "Show 3 more »" link
    Then verify that Assembly Utilizations are auto created
      | Report Item Type           | Running Hours During Month | Cycles During Month | TSN At Month End | CSN At Month End |
      | Engine 2                   | 400.00                     | 75                  | 5,200.00         | 3,275            |
      | APU                        | 400.00                     | 75                  | 5,400.00         | 3,075            |
      | Landing Gear - Left Main   | 400.00                     | 75                  | 2,600.00         | 1,675            |
      | Landing Gear - Right Main  | 400.00                     | 75                  | 5,400.00         | 2,575            |
      | Landing Gear - Nose        | 400.00                     | 75                  | 5,400.00         | 2,575            |
      | Landing Gear - Left Wing   | 400.00                     | 75                  | 5,400.00         | 2,575            |
      | Landing Gear - Right Wing  | 400.00                     | 75                  | 5,400.00         | 2,575            |
      | Engine 1                   | 200.00                     | 25                  | 5,200.00         | 3,025            |
  ...
  Scenario: Verify that after Monthly Utilization approval will not be able to update Monthly Utilization FH & FC
    ...
    Then verify following error message is displayed "You cannot modify a Monthly Utilization that is already approved."
...
#      | $199,800.00                      | $35,000.00   | $40,000.00   | $20,000.00 | $3,000.00            | $12,000.00              | $15,000.00              | $28,000.00       | $32,000.00       | $3,000.00                    | $2,800.00                    | $3,000.00               | $2,800.00                     | $3,200.00                     |
    ...
    Then verify that newly added record is displayed under section "Invoices"
      | Invoice Name |
      | O8429-A003-MR |
    And user selects newly added "O8429-A003-MR" Invoice
